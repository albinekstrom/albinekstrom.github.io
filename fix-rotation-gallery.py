...
# Fix Rotation Gallery Generator - Correctly identify which image needs rotation
# The original senja-14.jpg should be rotated, but it became senja-09 in our gallery

import os
import random

def generate_fixed_gallery():
    ...
    for row_idx, row in enumerate(layout):
        ...
        for slot_idx, slot in enumerate(row):
            if slot is None:
                ...
                # CORRECT ROTATION: Only senja-09 (which was original senja-14) needs rotation
                needs_rotation = (img_num == 9)  # senja-09 was the original senja-14
